...
type User struct {
	...
	Gender        constants.Gender    `gorm:"type:varchar(20);not null;column:gender" json:"gender"`
	...
	Role          constants.Role      `gorm:"type:varchar(20);not null;default:'user';column:role" json:"role"`
